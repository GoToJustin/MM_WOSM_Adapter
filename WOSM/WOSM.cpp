...
const char* g_DeviceNameWOSMDACs = "WOSM-DACs";
const char* g_DeviceNameWOSMDACt = "WOSM-DACt";
const char* g_DeviceNameWOSMDACu = "WOSM-DACu";
const char* g_DeviceNameWOSMDACv = "WOSM-DACv";
const char* g_DeviceNameWOSMDACw = "WOSM-DACw";
const char* g_DeviceNameWOSMDACx = "WOSM-DACx";
const char* g_DeviceNameWOSMDACy = "WOSM-DACy";
const char* g_DeviceNameWOSMDACz = "WOSM-DACz";

const char* g_DeviceNameWOSMPWM1 = "WOSM-PWM1";
const char* g_DeviceNameWOSMPWM2 = "WOSM-PWM2";
const char* g_DeviceNameWOSMPWM3 = "WOSM-PWM3";
const char* g_DeviceNameWOSMPWM4 = "WOSM-PWM4";
const char* g_DeviceNameWOSMPWM5 = "WOSM-PWM5";
...
MODULE_API void InitializeModuleData()
{
    ...
    RegisterDevice(g_DeviceNameWOSMDACs, MM::SignalIODevice, "DAC channel s");
    RegisterDevice(g_DeviceNameWOSMDACt, MM::SignalIODevice, "DAC channel t");
    RegisterDevice(g_DeviceNameWOSMDACu, MM::SignalIODevice, "DAC channel u");
    RegisterDevice(g_DeviceNameWOSMDACv, MM::SignalIODevice, "DAC channel v");
    RegisterDevice(g_DeviceNameWOSMDACw, MM::SignalIODevice, "DAC channel w");
    RegisterDevice(g_DeviceNameWOSMDACx, MM::SignalIODevice, "DAC channel x");
    RegisterDevice(g_DeviceNameWOSMDACy, MM::SignalIODevice, "DAC channel y");
    RegisterDevice(g_DeviceNameWOSMDACz, MM::SignalIODevice, "DAC channel z");

    RegisterDevice(g_DeviceNameWOSMPWM1, MM::SignalIODevice, "PWM channel 1");
    RegisterDevice(g_DeviceNameWOSMPWM2, MM::SignalIODevice, "PWM channel 2");
    RegisterDevice(g_DeviceNameWOSMPWM3, MM::SignalIODevice, "PWM channel 3");
    RegisterDevice(g_DeviceNameWOSMPWM4, MM::SignalIODevice, "PWM channel 4");
    RegisterDevice(g_DeviceNameWOSMPWM5, MM::SignalIODevice, "PWM channel 5");
...
MODULE_API MM::Device* CreateDevice(const char* deviceName)
{
    ...
    if ( strcmp(deviceName, g_DeviceNameWOSMHub) == 0 )          return new CWOSMHub;
    else if ( strcmp(deviceName, g_DeviceNameWOSMSwitch) == 0 )  return new CWOSMSwitch;
    else if ( strcmp(deviceName, g_DeviceNameWOSMShutter) == 0 ) return new CWOSMShutter;

    else if ( strcmp(deviceName, g_DeviceNameWOSMDACs) == 0 ) return new CWOSMDA(0); // s= channel 0
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACt) == 0 ) return new CWOSMDA(1); // t= channel 1
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACu) == 0 ) return new CWOSMDA(2); // u= channel 2
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACv) == 0 ) return new CWOSMDA(3); // v= channel 3
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACw) == 0 ) return new CWOSMDA(4); // w= channel 4
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACx) == 0 ) return new CWOSMDA(5); // x= channel 5
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACy) == 0 ) return new CWOSMDA(6); // y= channel 6
    else if ( strcmp(deviceName, g_DeviceNameWOSMDACz) == 0 ) return new CWOSMDA(7); // z= channel 7

    else if ( strcmp(deviceName, g_DeviceNameWOSMPWM1) == 0 ) return new CWOSMDA(8); // PWM1 = channel 8
    else if ( strcmp(deviceName, g_DeviceNameWOSMPWM2) == 0 ) return new CWOSMDA(9); // PWM2 = channel 9
    else if ( strcmp(deviceName, g_DeviceNameWOSMPWM3) == 0 ) return new CWOSMDA(10);// PWM3 = channel 10
    else if ( strcmp(deviceName, g_DeviceNameWOSMPWM4) == 0 ) return new CWOSMDA(11);// PWM4 = channel 11
    else if ( strcmp(deviceName, g_DeviceNameWOSMPWM5) == 0 ) return new CWOSMDA(12);// PWM5 = channel 12

    else if ( strcmp(deviceName, g_DeviceNameStage) == 0 )    return new CWOSMStage();
    else if ( strcmp(deviceName, g_DeviceNameXYStage) == 0 )  return new CWOSMXYStage();
    else if ( strcmp(deviceName, g_DeviceNameWOSMInput) == 0 )return new CWOSMInput;
    return 0;
}
...
int CWOSMHub::DetectInstalledDevices()
{
    if ( MM::CanCommunicate == DetectDevice() )
    {
        ...
        peripherals.push_back(g_DeviceNameWOSMDACs);
        peripherals.push_back(g_DeviceNameWOSMDACt);
        peripherals.push_back(g_DeviceNameWOSMDACu);
        peripherals.push_back(g_DeviceNameWOSMDACv);
        peripherals.push_back(g_DeviceNameWOSMDACw);
        peripherals.push_back(g_DeviceNameWOSMDACx);
        peripherals.push_back(g_DeviceNameWOSMDACy);
        peripherals.push_back(g_DeviceNameWOSMDACz);

        peripherals.push_back(g_DeviceNameWOSMPWM1);
        peripherals.push_back(g_DeviceNameWOSMPWM2);
        peripherals.push_back(g_DeviceNameWOSMPWM3);
        peripherals.push_back(g_DeviceNameWOSMPWM4);
        peripherals.push_back(g_DeviceNameWOSMPWM5);
...
// ****changed****
 //   SetPropertyLimits(MM::g_Keyword_State, 0, 256 - 1);
      SetPropertyLimits(MM::g_Keyword_State, 0, 8192 - 1);
...
// command: 1 now "dig_out" Set current digital output pattern 
// The "CWOSMShutter" NO LONGER uses this command!
...
int CWOSMSwitch::WriteToPort(long value)
{
    ...
    int ret = DEVICE_OK;
        ...
        // keep the lowest 8 bits and shift left 18bits to get the correct bit mask pattern
        valueL = valueL << 18;
...
// now do the PWM channels...
        leng = snprintf(( char* ) command, 50, "pwm_on %d\r\n", valueH);
        ret = hub->WriteToComPortH(( const unsigned char* ) command, leng);
        if ( ret != DEVICE_OK )  return ret;
        std::ostringstream xos;
        xos << "SWITCH::WriteToPort Command= " << command;
...
// shift left 18bits to get the correct bit mask pattern
        valueL = valueL << 18;
    ...
    gateOpen_(true)
{
    ...
    */
    ...
    if ( channel_ == 0 )      name_ = g_DeviceNameWOSMDACs;
    else if ( channel_ == 1 ) name_ = g_DeviceNameWOSMDACt;
    else if ( channel_ == 2 ) name_ = g_DeviceNameWOSMDACu;
    else if ( channel_ == 3 ) name_ = g_DeviceNameWOSMDACv;
    else if ( channel_ == 4 ) name_ = g_DeviceNameWOSMDACw;
    else if ( channel_ == 5 ) name_ = g_DeviceNameWOSMDACx;
    else if ( channel_ == 6 ) name_ = g_DeviceNameWOSMDACy;
    else if ( channel_ == 7 ) name_ = g_DeviceNameWOSMDACz;
    else if ( channel_ == 8 ) name_ = g_DeviceNameWOSMPWM1;
    else if ( channel_ == 9 ) name_ = g_DeviceNameWOSMPWM2;
    else if ( channel_ == 10 ) name_ = g_DeviceNameWOSMPWM3;
    else if ( channel_ == 11 ) name_ = g_DeviceNameWOSMPWM4;
    else if ( channel_ == 12 ) name_ = g_DeviceNameWOSMPWM5;
...
int CWOSMDA::WriteToPort(double value)
{
    ...
    if ( ( channel_ >= 0 ) && ( channel_ < 12 ) ) {
        if ( channel_ < 8 ) {
            chan[0] = ( char ) ( 's' + channel_); chan[1] = 0;     // set DAC channels "s - z" on WOSM
